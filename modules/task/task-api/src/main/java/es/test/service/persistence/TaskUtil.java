...
public class TaskUtil {
	 ...
	 * @return the matching tasks
	 */
	public static List<Task> findByGroupIdUserIdCompleted(
		long groupId, long userId, boolean completed) {

		return getPersistence().findByGroupIdUserIdCompleted(
			groupId, userId, completed);
	}
	...
	public static List<Task> findByGroupIdUserIdCompleted(
		...
		return getPersistence().findByGroupIdUserIdCompleted(
			groupId, userId, completed, start, end);
	}
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByGroupIdUserIdCompleted_First(
			long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws es.test.exception.NoSuchTaskException {

		return getPersistence().findByGroupIdUserIdCompleted_First(
	 ...
	 * @return the first matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByGroupIdUserIdCompleted_First(
		long groupId, long userId, boolean completed,
		OrderByComparator<Task> orderByComparator) {

		return getPersistence().fetchByGroupIdUserIdCompleted_First(
			groupId, userId, completed, orderByComparator);
	}
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByGroupIdUserIdCompleted_Last(
			long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws es.test.exception.NoSuchTaskException {

		return getPersistence().findByGroupIdUserIdCompleted_Last(
			groupId, userId, completed, orderByComparator);
	}
	 ...
	 * @return the last matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByGroupIdUserIdCompleted_Last(
		long groupId, long userId, boolean completed,
		OrderByComparator<Task> orderByComparator) {

		return getPersistence().fetchByGroupIdUserIdCompleted_Last(
			groupId, userId, completed, orderByComparator);
	}
	 ...
	 * @throws NoSuchTaskException if a task with the primary key could not be found
	 */
	public static Task[] findByGroupIdUserIdCompleted_PrevAndNext(
			long taskId, long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws es.test.exception.NoSuchTaskException {

		return getPersistence().findByGroupIdUserIdCompleted_PrevAndNext(
			taskId, groupId, userId, completed, orderByComparator);
	}
	 ...
	 * @param completed the completed
	 */
	public static void removeByGroupIdUserIdCompleted(
		long groupId, long userId, boolean completed) {

		getPersistence().removeByGroupIdUserIdCompleted(
			groupId, userId, completed);
	}
	 ...
	 * @return the number of matching tasks
	 */
	public static int countByGroupIdUserIdCompleted(
		long groupId, long userId, boolean completed) {

		return getPersistence().countByGroupIdUserIdCompleted(
			groupId, userId, completed);
	}
